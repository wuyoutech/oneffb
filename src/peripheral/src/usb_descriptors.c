...
uint8_t const desc_fs_configuration[] = {
    ...
    // TODO: change HID length and descriptor
    // BIT INTERVAL:0x01:1000Hz
    TUD_HID_INOUT_DESCRIPTOR(ITF_NUM_HID, 5, HID_ITF_PROTOCOL_NONE, 1213,
                             EPNUM_HID_OUT, EPNUM_HID_IN, 64, 0x01),
};
...
__ALIGN_BEGIN const uint8_t hid_2ffb_desc[] __ALIGN_END =
{
